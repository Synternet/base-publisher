...
import (
	...
	svc "github.com/synternet/base-publisher/internal/service"
	"github.com/synternet/base-publisher/pkg/ipc"
...
func main() {
	...
	setDefault(PUBLISHER_NAME, "base")
	...
	if *flagIpcPath == "" {
		panic(fmt.Errorf("missing IPC path"))
	}
